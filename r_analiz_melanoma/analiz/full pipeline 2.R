...
DATA_DIR   <- "C:/Users/HP/OneDrive/Documents/melanoma_analysis" # directory containing the .gz files
...
mrna_files <- list(
  A375_RC  = file.path(DATA_DIR, "GSM8658654_A375-RK_mRNA_count.txt"),
  A375_R10 = file.path(DATA_DIR, "GSM8658655_A375-R-10_mRNA_count.txt"),
  A375_SC  = file.path(DATA_DIR, "GSM8658656_A375-S-K_mRNA_count.txt"),
  A375_S10 = file.path(DATA_DIR, "GSM8658657_A375-S-10_mRNA_count.txt")
)
as.data_frame
mrna_raw <- list()
...
deg_mirna_SC_vs_S10 <- get_deg_df(mirna_comp2)
